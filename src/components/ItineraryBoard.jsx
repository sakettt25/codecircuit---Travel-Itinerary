...
const ItineraryBoard = () => {
  ...
  // Delete only the last day (never Day 1)
  const deleteDay = (day) => {
  ...
  // Ensure activities state always has keys for all days
  useEffect(() => {
    setActivities((prev) => {
      const updated = { ...prev };
  ...
  // DayCard with delete button ONLY for the last day (not Day 1), and hover effect
  ...
  return (
    <DndProvider backend={HTML5Backend}>
      ...
      {/* Animated Day Cards + Add Day Card */}
